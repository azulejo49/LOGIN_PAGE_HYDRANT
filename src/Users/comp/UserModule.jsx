              ...
              <div className="user-box-content">
                <div className="user-box-title">
                  <div className='userLogoWraper'>
                    <div className='userLogoMask' />
                      <img className='userLogo' src={user.picture_url? user.picture_url : avatar} alt={`תמונת משתמש`}/>
                  </div>
                ...
                <div className="btnContainer">
                  {userInfo.mng_access_list.usersEdit &&
                    <Link to={`update/${user.user_id}`} state={{ data: user }}>
                      <button className='btn'>ערוך&nbsp;משתמש&nbsp;<FontAwesomeIcon icon={faPencilAlt} />
                      </button>
                    </Link>}
                </div>
