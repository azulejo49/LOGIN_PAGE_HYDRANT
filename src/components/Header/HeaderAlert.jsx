...
export default function HeaderAlert() {
    ...
    const { eventsArr, setFocusedEvent } = useContext(MyContext)
    ...
    return (
        <>
            <div className='topLine' style={(showAlert) ? { backgroundColor: 'var(--red)' } : { backgroundColor: 'var(--green)' }} />
            {(showAlert) &&
                <div className='header-alert-wrapper'>
                    ...
                    <div className='footer-alert'></div>
                </div>
            }
        </>
    )
