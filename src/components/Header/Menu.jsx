      ...
      {userInfo &&
        <div ref={refer} className={`menu ${active}`}>
          <div className="menuCategory">
            ...
            {userInfo.ui_access_list.events && <NavLink to="/events/" onClick={handleClick}><p>כל הארועים</p></NavLink>}
            <h3>אירועים פתוחים</h3>
            {userInfo.ui_access_list.events && <NavLink to="/flow/" onClick={handleClick}><p>{EVENTS_TITLES.trig1}</p></NavLink>}
            {userInfo.ui_access_list.events && <NavLink to="/reverse/" onClick={handleClick}><p>{EVENTS_TITLES.trig2}</p></NavLink>}
            {userInfo.ui_access_list.events && <NavLink to="/vandalisem/" onClick={handleClick}><p>{EVENTS_TITLES.trig3}</p></NavLink>}
            {userInfo.ui_access_list.events && <NavLink to="/battery/" onClick={handleClick}><p>{EVENTS_TITLES.trig5}</p></NavLink>}
            {userInfo.ui_access_list.events && <NavLink to="/lifeSignal/" onClick={handleClick}><p>{EVENTS_TITLES.trig6}</p></NavLink>}
            {userInfo.ui_access_list.events && <NavLink to="/pressure/" onClick={handleClick}><p>{EVENTS_TITLES.trig7}</p></NavLink>}
          ...
          <div className="menuCategory">
            {userInfo && userInfo.mng_access_list ?
              <>
                ...
                {userInfo.mng_access_list.customersAccess && <NavLink to="/customers/" onClick={handleClick}><p>תאגידים</p></NavLink>}
