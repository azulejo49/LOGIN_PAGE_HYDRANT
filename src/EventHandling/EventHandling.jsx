...
export default function EventHandling() {
    ...
    const { userInfo, setUserInfo, accessToken, setIsLoading } = useContext(MyContext);
    ...
    useEffect(() => { myHandles && setIsLoading(false) }, [myHandles])
                        ...
                        <label key={idx} htmlFor={`hydrantId_${hydrant.hydrant_id}`}>
                            ...
                            <div className='hydrant'>
                                <div className='hydarantHeader'>
                                    ...
                                    <p className='eventHydantId'>{hydrant.hydrant_id}</p>
                                    ...
                                    {hydrant.events.map((event, idx) =>
                                        <div key={idx} className='handleWraper'>
                                            ...
                                            <button
                                                ...
                                                טופל&nbsp;<FontAwesomeIcon icon={faCheck} />
                                            </button>
                                        </div>
                                    )}
                                </div>
