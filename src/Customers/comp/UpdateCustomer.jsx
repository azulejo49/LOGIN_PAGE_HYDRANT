...
import { faRotateRight, faAddressCard, faTrashAlt, faCloudUpload } from '@fortawesome/free-solid-svg-icons'
import { uploadImage } from '../../services/firebase'
import { addressToCord, CordToAddress } from '../../services/geoCode';
import MyNotification from '../../services/MyNotification'

function UpdateCustomer({ HandleUpdateData }) {
...
const getCurrentLocation = (e) => {
  ...
  return (
    <div className="window" >
      ...
      <header>
        <h3 className='title'>עדכון תאגיד</h3>
      </header>
