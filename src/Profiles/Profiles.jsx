        ...
        <div className='header-button-wraper'>
          {userInfo && userInfo.mng_access_list.profilesEdit &&
            <NavLink to="add" style={({ isActive }) => isActive ? { display: "none" } : {}}>
              <button className="btn" title='יצירת פרופיל'>פרופיל&nbsp;חדש&nbsp;<FontAwesomeIcon icon={faUserPlus} /></button>
            </NavLink>}
          <div className="search">
            <input  type='search' title='חיפוש פרופיל' placeholder='חפש פרופיל' value={searchString} onChange={(e) => setSearchString(e.target.value)}></input>
